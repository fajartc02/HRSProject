...
loader.load('ToyotaHRIS.glb', function (gltf) {
  ...
  buttonMesh = model.getObjectByName("Torso_3");
  buttonRMesh = model.getObjectByName("Head_3");
  ...
  if (buttonRMesh) {
    ...
    changeObjectColor(buttonRMesh, 0x331100);
  }
...
function onClick(event) {
  ...
  const buttonMeshIntersects = raycaster.intersectObject(buttonMesh);
  const buttonRMeshIntersects = raycaster.intersectObject(buttonRMesh);
